...
function Duplication.Init(Tab)
    ...
    Tab:CreateToggle("Structures", false, function(s) env.DupeItems.Structures = s end)
    Tab:CreateToggle("Blueprints", false, function(s) env.DupeItems.Structures = s end)
    ...
    Tab:CreateToggle("Planks", false, function(s) env.DupeItems.Decorations = s end)
